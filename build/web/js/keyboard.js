...
(function VKI_buildKeyboardInputs() {
  ...
  //   on the corresponding key.  This allows for easy localization
  //   of key names.
  //
  ...
  var thead = document.createElement('thead');
    var tr = document.createElement('tr');
      var th = document.createElement('th');
          th.colSpan = "2";
/* Eliminando la opción de elegir idioma
...
/* Eliminando el "Clear"
        var span = document.createElement('span');
          ...
          th.appendChild(span);
*/
/* Eliminando la opci�n de cerrar la entana
...
*/
  ...
  this.VKI_insert = function(text) {
    ...
    //you are here if some character is selected in the virtual keyboard
    //this is the better place to call the autocomplete function... I hope ;-)

    //alert("Now the string es: "+this.VKI_target.value);
    //var field = document.getElementById("querytext");
  ...
  this.VKI_position = function(force) {
    if (self.VKI_target) {
      ...
      // Originally was +3 instead of +150
      var place = false, fudge = self.VKI_target.offsetHeight + 150;
      if (force !== true) {
